...
define('ZO_PLUGIN_VERSION', '1.5.77.asker.arslan');
...
function zo_get_runtime_translation_exact_map($lang) {
	...
	$more_runtime_exact_two = array(
		'tr' => array(
			'Tap Start' => 'Başlat’a dokun',
			'Wait...' => 'Bekle...',
			...
			'Try these examples:' => 'Bu örnekleri dene:',
			'Choose parts wisely.' => 'Parçaları dikkatli seç.',
			'Mission success. Robot performed well.' => 'Görev başarılı. Robot iyi çalıştı.',
			'Mission failed. Adjust your design.' => 'Görev başarısız. Tasarımını düzelt.',
			'Remember the order, then tap it back' => 'Sırayı hatırla, sonra aynı sırayla dokun',
			'Renkli toplara tıkla. Ses çıkar.' => 'Renkli toplara tıkla. Ses çıkar.',
			'Patlat ve dinle.' => 'Patlat ve dinle.',
			'Watch the glowing path.' => 'Parlayan yolu izle.',
			'Repeat the path in order.' => 'Yolu sırayla tekrarla.',
			'Path jumped. Retry.' => 'Yol atladı. Tekrar dene.',
			'Great job! Press start for next round.' => 'Harika! Sonraki tur için başlat.',
			'Wrong order. Press start to try again.' => 'Yanlış sıra. Tekrar denemek için başlat.',
			'Press start to begin.' => 'Başlamak için başlat.',
			'You are out of lives. Press Start.' => 'Canın kalmadı. Başlat’a bas.',
			'Get ready...' => 'Hazırlan...',
			'Pick the OPPOSITE.' => 'TERSİNİ seç.',
			'Choose a move.' => 'Bir hamle seç.',
			'Game over. Press Start.' => 'Oyun bitti. Başlat’a bas.',
			'Ready.' => 'Hazır.',
			'Listen carefully.' => 'Dikkatle dinle.',
			'Repeat the pattern.' => 'Deseni tekrarla.',
			'Wrong note.' => 'Yanlış nota.',
			'No lives. Press Start.' => 'Can kalmadı. Başlat’a bas.',
			'Great! Next round.' => 'Harika! Sonraki tur.',
			'Round started.' => 'Tur başladı.',
			'Use Reinforce' => 'Takviye Kullan',
			'Choose a cell to expand or attack.' => 'Genişlemek veya saldırmak için bir hücre seç.',
			'Attack failed. The enemy held strong.' => 'Saldırı başarısız. Düşman güçlü kaldı.',
			'AI captured territory this turn.' => 'Yapay zeka bu tur bölge aldı.',
			'AI attack failed. Your border remains intact.' => 'Yapay zeka saldırısı başarısız. Sınırın sağlam.',
			'AI used reinforce and claimed a neutral border cell.' => 'Yapay zeka takviye kullandı ve tarafsız sınır hücresi aldı.',
			'No player moves left. AI continues.' => 'Oyuncu hamlesi kalmadı. Yapay zeka devam ediyor.',
			'AI cannot move. Your turn.' => 'Yapay zeka hamle yapamıyor. Sıra sende.',
			'You win! Great territory control.' => 'Kazandın! Harika bölge kontrolü.',
			'AI wins! Try a different strategy.' => 'Yapay zeka kazandı! Farklı bir strateji dene.',
			'It\'s a tie! A balanced battle.' => 'Berabere! Dengeli bir savaş.',
			'No neutral border cell available to reinforce.' => 'Takviye için tarafsız sınır hücresi yok.',
			'Reinforce used! You claimed a border space.' => 'Takviye kullanıldı! Bir sınır alanı aldın.',
			'Your turn! Click a cell to claim it.' => 'Sıra sende! Almak için bir hücreye tıkla.',
			'AI is thinking...' => 'Yapay zeka düşünüyor...',
			'Your turn!' => 'Sıra sende!',
			'🎉 You Win! You claimed more territory!' => 'Kazandın! Daha fazla bölge aldın!',
			'😢 AI Wins! Better luck next time!' => 'Yapay zeka kazandı! Bir dahaki sefere.',
			'Choose 4 to 6 tokens' => '4 ila 6 jeton seç',
			'Live' => 'Canlı',
			'Stopped' => 'Durdu',
			'Blue korner. Click or tap where you want the korner kick to go. You can aim at goal.' => 'Mavi korner. Korner vuruşunun gitmesini istediğin yere tıkla veya dokun. Kaleye nişan alabilirsin.',
			'Your teammate has the ball. Click or tap where to kick. Click at the goal to shoot.' => 'Takım arkadaşında top var. Nereye vuracağını tıkla veya dokun. Şut için kaleye tıkla.',
			'Watch the loop sequence.' => 'Döngü sırasını izle.',
			'Repeat it now.' => 'Şimdi tekrarla.',
			'Add all 5 moves.' => '5 hamlenin hepsini ekle.',
			'Great loop! You reached the goal.' => 'Harika döngü! Hedefe ulaştın.',
			'Every 5 seconds the game sends 1 enemy. More Enemies sends 2.' => 'Her 5 saniyede oyun 1 düşman gönderir. Daha Fazla Düşman 2 gönderir.',
			'TREASURE' => 'HAZİNE',
			'TRAP' => 'TUZAK',
			'You found all the treasure. You win.' => 'Tüm hazineyi buldun. Kazandın.',
			'You hit a trap. Game over.' => 'Tuzağa bastın. Oyun bitti.',
			'Wrong order!' => 'Yanlış sıra!',
			'Build the word' => 'Kelimeyi oluştur',
			'No country selected yet' => 'Henüz ülke seçilmedi',
			'Write a country name in Turkish or English, then press Start Quiz.' => 'Türkçe veya İngilizce bir ülke adı yaz, sonra Teste Başla’ya bas.',
			'You found the hidden stars.' => 'Gizli yıldızları buldun.',
			'You win.' => 'Kazandın.',
			'Try again and catch more stars.' => 'Tekrar dene ve daha çok yıldız yakala.',
			'Nice catch.' => 'Güzel yakaladın.',
			'Too slow. Watch for the next one.' => 'Çok yavaş. Sonrakini izle.',
			'Private game. Embed directly where you want it.' => 'Özel oyun. İstediğin yere doğrudan yerleştir.',
		),
		'en' => array(
			'Soru 0 / 100' => 'Question 0 / 100',
			'Bir ülke adı yaz ve başlat.' => 'Write a country name and start.',
			'Ülke: ' => 'Country: ',
			'Renkli toplara tıkla. Ses çıkar.' => 'Click the colored balls. Make sound.',
			'Patlat ve dinle.' => 'Pop and listen.',
			'Dükkan Seviyesi ' => 'Shop Level ',
			'Başlamak için Başla butonuna bas' => 'Press Start to begin',
			'Süre bitti' => 'Time is up',
		),
		'de' => array(
			'Tap Start' => 'Tippe Start',
			'Wait...' => 'Warte...',
			...
			'Try these examples:' => 'Probiere diese Beispiele:',
			'Choose parts wisely.' => 'Wähle Teile klug.',
			'Mission success. Robot performed well.' => 'Mission erfolgreich. Der Roboter war gut.',
			'Mission failed. Adjust your design.' => 'Mission fehlgeschlagen. Passe dein Design an.',
			'Remember the order, then tap it back' => 'Merke die Reihenfolge und tippe sie nach',
			'Watch the glowing path.' => 'Beobachte den leuchtenden Pfad.',
			'Repeat the path in order.' => 'Wiederhole den Pfad der Reihe nach.',
			'Path jumped. Retry.' => 'Pfad gesprungen. Erneut versuchen.',
			'Great job! Press start for next round.' => 'Gut gemacht! Drücke Start für die nächste Runde.',
			'Press start to begin.' => 'Drücke Start zum Beginnen.',
			'Get ready...' => 'Mach dich bereit...',
			'Pick the OPPOSITE.' => 'Wähle das GEGENTEIL.',
			'Choose a move.' => 'Wähle einen Zug.',
			'Ready.' => 'Bereit.',
			'Listen carefully.' => 'Hör genau hin.',
			'Repeat the pattern.' => 'Wiederhole das Muster.',
			'Wrong note.' => 'Falscher Ton.',
			'Round started.' => 'Runde gestartet.',
			'Use Reinforce' => 'Verstärkung nutzen',
			'AI is thinking...' => 'Die KI denkt...',
			'Your turn!' => 'Du bist dran!',
			'Live' => 'Live',
			'Stopped' => 'Gestoppt',
			'TREASURE' => 'SCHATZ',
			...
			'Build the word' => 'Baue das Wort',
			'No country selected yet' => 'Noch kein Land ausgewählt',
			'Nice catch.' => 'Guter Fang.',
		),
		'fr' => array(
			'Tap Start' => 'Touche Démarrer',
			'Wait...' => 'Attends...',
			'CLICK NOW' => 'CLIQUE MAINTENANT',
			'Too Soon' => 'Trop tôt',
			'You win!' => 'Tu gagnes !',
			'You lose!' => 'Tu perds !',
			'Make your move.' => 'Fais ton coup.',
			'AI Assistant:' => 'Assistant IA :',
			'Try these examples:' => 'Essaie ces exemples :',
			'Choose parts wisely.' => 'Choisis bien les pièces.',
			'Mission success. Robot performed well.' => 'Mission réussie. Le robot a bien réussi.',
			'Mission failed. Adjust your design.' => 'Mission échouée. Ajuste ton design.',
			'Remember the order, then tap it back' => 'Mémorise l ordre puis retape-le',
			'Watch the glowing path.' => 'Regarde le chemin lumineux.',
			'Repeat the path in order.' => 'Répète le chemin dans l ordre.',
			'Path jumped. Retry.' => 'Le chemin a sauté. Réessaie.',
			'Great job! Press start for next round.' => 'Bien joué ! Appuie sur démarrer pour la manche suivante.',
			'Press start to begin.' => 'Appuie sur démarrer pour commencer.',
			'Get ready...' => 'Prépare-toi...',
			'Pick the OPPOSITE.' => 'Choisis l OPPOSÉ.',
			'Choose a move.' => 'Choisis un mouvement.',
			'Ready.' => 'Prêt.',
			'Listen carefully.' => 'Écoute attentivement.',
			'Repeat the pattern.' => 'Répète le motif.',
			'Wrong note.' => 'Mauvaise note.',
			'Round started.' => 'Manche commencée.',
			'Use Reinforce' => 'Utiliser renfort',
			'AI is thinking...' => 'L IA réfléchit...',
		...
		'es-mx' => array(
			...
			'Choose parts wisely.' => 'Elige piezas con cuidado.',
			'Mission success. Robot performed well.' => 'Misión exitosa. El robot funcionó bien.',
			'Mission failed. Adjust your design.' => 'Misión fallida. Ajusta tu diseño.',
			'Remember the order, then tap it back' => 'Recuerda el orden y tócalo de vuelta',
			'Watch the glowing path.' => 'Mira el camino brillante.',
			'Repeat the path in order.' => 'Repite el camino en orden.',
			'Path jumped. Retry.' => 'El camino saltó. Intenta otra vez.',
			'Great job! Press start for next round.' => '¡Muy bien! Presiona iniciar para la siguiente ronda.',
			'Press start to begin.' => 'Presiona iniciar para empezar.',
			'Get ready...' => 'Prepárate...',
			'Pick the OPPOSITE.' => 'Elige lo OPUESTO.',
			'Choose a move.' => 'Elige un movimiento.',
			'Ready.' => 'Listo.',
			...
			'TRAP' => 'TRAMPA',
			'You found all the treasure. You win.' => 'Encontraste todo el tesoro. Ganaste.',
			'You hit a trap. Game over.' => 'Tocaste una trampa. Fin del juego.',
			'Build the word' => 'Construye la palabra',
			'No country selected yet' => 'Todavía no hay país seleccionado',
			'Nice catch.' => 'Buena captura.',
		),
	);
	$more_runtime_exact_two['es-es'] = array_merge($more_runtime_exact_two['es-mx'], array(
		'No country selected yet' => 'Todavía no hay ningún país seleccionado',
	));

	foreach ($more_runtime_exact_two as $more_exact_two_lang => $more_exact_two_items) {
		if (isset($translations[$more_exact_two_lang])) {
			$translations[$more_exact_two_lang] = array_merge($translations[$more_exact_two_lang], $more_exact_two_items);
		}
	}

	$roster_runtime_exact = array(
		'tr' => array(
			'Roster 1000' => '1000 Karakter Arenası',
			'Roster 1000 Arena' => '1000 Karakter Arenası',
			'Roster 1000 arena' => '1000 Karakter arenası',
			'Fight through endless arena waves, earn 50 coins for every win, and grow your team by buying from a generated roster of 1000 heroes. Higher levels send more enemies with smarter movement and stronger attacks.' => 'Sonsuz arena dalgalarında savaş, her galibiyette 50 coin kazan ve 1000 kahramanlık listeden satın alarak takımını büyüt. Yüksek seviyeler daha akıllı hareket eden ve daha güçlü saldıran daha fazla düşman gönderir.',
			'Enemies' => 'Düşmanlar',
			'Hero' => 'Kahraman',
			'Wins' => 'Galibiyet',
			'Next Wave' => 'Sonraki Dalga',
			'Restart Run' => 'Koşuyu Yeniden Başlat',
			'Up' => 'Yukarı',
			'Left' => 'Sol',
			'Down' => 'Aşağı',
			'Right' => 'Sağ',
			'Use arrow keys or WASD on desktop. On mobile, tap the arena to move toward that point or use the move buttons. Clear each wave to earn 50 coins, then buy stronger characters.' => 'Bilgisayarda ok tuşlarını veya WASD kullan. Mobilde o noktaya gitmek için arenaya dokun veya hareket düğmelerini kullan. Her dalgayı temizleyip 50 coin kazan, sonra daha güçlü karakterler satın al.',
			'Pick or buy a character, then press Start. Each cleared wave gives 50 coins.' => 'Bir karakter seç veya satın al, sonra Başlat’a bas. Temizlenen her dalga 50 coin verir.',
			'1000 Hero Shop' => '1000 Kahraman Mağazası',
			'Prev' => 'Önceki',
			'Hero #' => 'Kahraman #',
			'Jump to hero number' => 'Kahraman numarasına git',
			'Go' => 'Git',
			'HP' => 'Can',
			'Power' => 'Güç',
			'Rapid' => 'Hızlı',
			'Selected' => 'Seçili',
			'Select' => 'Seç',
			'Fast feet and quick shots.' => 'Hızlı ayaklar ve hızlı atışlar.',
			'Stays alive longer in rough waves.' => 'Zorlu dalgalarda daha uzun hayatta kalır.',
			'Big hits with steady control.' => 'Dengeli kontrolle güçlü vuruşlar.',
			'Balanced arena duelist.' => 'Dengeli arena düellocusu.',
			'Rapid fire pressure specialist.' => 'Hızlı ateş baskısı uzmanı.',
			'Slow, tough, and heavy-handed.' => 'Yavaş, dayanıklı ve ağır vuruşlu.',
			'Press Start to begin your run.' => 'Koşuya başlamak için Başlat’a bas.',
		),
		'de' => array(
			'1000 Hero Shop' => '1000-Helden-Shop',
			'Enemies' => 'Gegner',
			'Hero' => 'Held',
			'Wins' => 'Siege',
			'Next Wave' => 'Nächste Welle',
			'Restart Run' => 'Lauf neu starten',
			'Up' => 'Hoch',
			'Left' => 'Links',
			'Down' => 'Runter',
			'Right' => 'Rechts',
			'Prev' => 'Zurück',
			'Hero #' => 'Held #',
			'Jump to hero number' => 'Zur Heldennummer springen',
			'Go' => 'Los',
			'HP' => 'LP',
			'Power' => 'Kraft',
			'Rapid' => 'Tempo',
			'Selected' => 'Ausgewählt',
			'Select' => 'Auswählen',
			'Pick or buy a character, then press Start. Each cleared wave gives 50 coins.' => 'Wähle oder kaufe einen Charakter und drücke Start. Jede besiegte Welle gibt 50 Münzen.',
			'Press Start to begin your run.' => 'Drücke Start, um deinen Lauf zu beginnen.',
		),
		'fr' => array(
			'1000 Hero Shop' => 'Boutique de 1000 héros',
			'Enemies' => 'Ennemis',
			'Hero' => 'Héros',
			'Wins' => 'Victoires',
			'Next Wave' => 'Vague suivante',
			...
			'Prev' => 'Préc.',
			'Hero #' => 'Héros #',
			'Jump to hero number' => 'Aller au numéro de héros',
			'Go' => 'Aller',
			'HP' => 'PV',
			'Power' => 'Puissance',
			'Rapid' => 'Rapide',
			'Selected' => 'Sélectionné',
			'Select' => 'Choisir',
			'Pick or buy a character, then press Start. Each cleared wave gives 50 coins.' => 'Choisis ou achète un personnage, puis appuie sur Démarrer. Chaque vague terminée donne 50 pièces.',
			'Press Start to begin your run.' => 'Appuie sur Démarrer pour commencer.',
		),
		'es-mx' => array(
			'1000 Hero Shop' => 'Tienda de 1000 héroes',
			'Enemies' => 'Enemigos',
			'Hero' => 'Héroe',
			'Wins' => 'Victorias',
			'Next Wave' => 'Siguiente ola',
			...
			'Prev' => 'Anterior',
			'Hero #' => 'Héroe #',
			'Jump to hero number' => 'Ir al número de héroe',
			'Go' => 'Ir',
			'HP' => 'PS',
			'Power' => 'Poder',
			'Rapid' => 'Rápido',
			...
			'Select' => 'Seleccionar',
			'Pick or buy a character, then press Start. Each cleared wave gives 50 coins.' => 'Elige o compra un personaje y presiona Iniciar. Cada ola completada da 50 monedas.',
			'Press Start to begin your run.' => 'Presiona Iniciar para empezar.',
		),
	);
	$roster_runtime_exact['es-es'] = array_merge($roster_runtime_exact['es-mx'], array(
		'Restart Run' => 'Reiniciar partida',
	));

	foreach ($roster_runtime_exact as $roster_exact_lang => $roster_exact_items) {
		if (isset($translations[$roster_exact_lang])) {
			$translations[$roster_exact_lang] = array_merge($translations[$roster_exact_lang], $roster_exact_items);
		}
	}

	$more_runtime_exact_three = array(
		'tr' => array(
			'All three services are restored. The city lights up again.' => 'Üç hizmet de geri geldi. Şehir yeniden ışıldıyor.',
			'There is no music track. Your shots create the rhythm, and enemies sync to your tempo.' => 'Müzik yok. Ritmi atışların oluşturur ve düşmanlar tempona uyar.',
			'Shot on beat. An enemy synced into your bullet.' => 'Vuruş ritimde. Bir düşman mermine denk geldi.',
			'The enemy matched your rhythm and rushed early.' => 'Düşman ritmini yakaladı ve erken saldırdı.',
			'You authored the rhythm and the room moved to your gunfire.' => 'Ritmi sen yazdın ve oda ateşine göre hareket etti.',
			'Start at ' => 'Başlangıç: ',
			'. Make jumps to land on ' => '. Hedefe inmek için zıpla: ',
			'Run Over' => 'Koşu Bitti',
			'Restart or buy a stronger fighter from the roster.' => 'Yeniden başla veya listeden daha güçlü bir savaşçı al.',
			'Out of catches. Press Start.' => 'Yakalama hakkı bitti. Başlat’a bas.',
			'Collect the target letter.' => 'Hedef harfi topla.',
			'Time over. Score: ' => 'Süre bitti. Skor: ',
			'Match the target in 5 moves.' => 'Hedefi 5 hamlede eşleştir.',
			'Aligned! Nice!' => 'Hizalandı! Güzel!',
			'Not aligned. Try again.' => 'Hizalanmadı. Tekrar dene.',
			'Sound Rule Rush' => 'Ses Kuralı Yarışı',
			'Victory' => 'Zafer',
			'Defeat' => 'Yenilgi',
			'Press Restart to play again.' => 'Tekrar oynamak için Yeniden Başlat’a bas.',
			'Base Defense' => 'Üs Savunması',
			'Place towers, then press Start.' => 'Kuleleri yerleştir, sonra Başlat’a bas.',
			'Blue Base' => 'Mavi Üs',
			'Red Base' => 'Kırmızı Üs',
			'Wit Bases' => 'Zeka Üsleri',
			'Monster Team vs Block World' => 'Canavar Takımı Blok Dünyasına Karşı',
		...
		'en' => array(
			...
			'Penaltı Kralı' => 'Penalty King',
			'Başlat ve şut çek' => 'Start and shoot',
			'Balon Patlatmalı' => 'Balloon Popper',
			'Kaçma Oyunu' => 'Escape Game',
			'SINIF' => 'CLASS',
			'TAHTA' => 'BOARD',
			'Yakalandın' => 'You were caught',
			'Öğretmenden Kaç' => 'Escape the Teacher',
			'Ahır' => 'Barn',
			'Hayvan Kurtarmalı' => 'Animal Rescue',
			'Kurtarılan: ' => 'Rescued: ',
			'Başlat düğmesine bas' => 'Press Start',
			'Tekrar başlamak için Baştan Başla düğmesine bas' => 'Press Restart to start again',
			'Tekrar başlat ve yeniden savaş.' => 'Restart and fight again.',
			'Başlat ve bir savaşçı gönder.' => 'Start and send a fighter.',
			'Ses Efektli Sürüm' => 'Sound Effects Version',
			'Başlat ve tıkla' => 'Start and click',
		),
		'de' => array(
			'All three services are restored. The city lights up again.' => 'Alle drei Dienste sind wiederhergestellt. Die Stadt leuchtet wieder.',
			'Run Over' => 'Lauf beendet',
			...
			'Collect the target letter.' => 'Sammle den Zielbuchstaben.',
			'Time over. Score: ' => 'Zeit vorbei. Punkte: ',
			'Match the target in 5 moves.' => 'Passe das Ziel in 5 Zügen an.',
			'Aligned! Nice!' => 'Ausgerichtet! Gut!',
			'Not aligned. Try again.' => 'Nicht ausgerichtet. Versuch es erneut.',
			'Victory' => 'Sieg',
			'Defeat' => 'Niederlage',
			'Base Defense' => 'Basisverteidigung',
			'Place towers, then press Start.' => 'Platziere Türme, dann drücke Start.',
			'Blue Base' => 'Blaue Basis',
			'Red Base' => 'Rote Basis',
		),
		'fr' => array(
			'All three services are restored. The city lights up again.' => 'Les trois services sont rétablis. La ville s allume de nouveau.',
			'Run Over' => 'Course terminée',
			'Restart or buy a stronger fighter from the roster.' => 'Recommence ou achète un combattant plus fort dans la liste.',
			'Out of catches. Press Start.' => 'Plus de prises. Appuie sur Démarrer.',
			'Collect the target letter.' => 'Collecte la lettre cible.',
			'Time over. Score: ' => 'Temps terminé. Score : ',
			'Match the target in 5 moves.' => 'Aligne la cible en 5 coups.',
			'Aligned! Nice!' => 'Aligné ! Bien joué !',
			'Not aligned. Try again.' => 'Pas aligné. Réessaie.',
			'Victory' => 'Victoire',
			'Defeat' => 'Défaite',
			'Base Defense' => 'Défense de base',
			'Place towers, then press Start.' => 'Place les tours, puis appuie sur Démarrer.',
			'Blue Base' => 'Base bleue',
			'Red Base' => 'Base rouge',
		),
		'es-mx' => array(
			...
			'Run Over' => 'Partida terminada',
			'Restart or buy a stronger fighter from the roster.' => 'Reinicia o compra un luchador más fuerte de la lista.',
			'Out of catches. Press Start.' => 'No quedan capturas. Presiona Iniciar.',
			'Collect the target letter.' => 'Recoge la letra objetivo.',
			'Time over. Score: ' => 'Tiempo terminado. Puntuación: ',
			'Match the target in 5 moves.' => 'Iguala el objetivo en 5 movimientos.',
			'Aligned! Nice!' => '¡Alineado! ¡Bien!',
			'Not aligned. Try again.' => 'No está alineado. Intenta otra vez.',
			'Victory' => 'Victoria',
			'Defeat' => 'Derrota',
			'Base Defense' => 'Defensa de base',
			'Place towers, then press Start.' => 'Coloca torres y luego presiona Iniciar.',
			'Blue Base' => 'Base azul',
			'Red Base' => 'Base roja',
		),
	);
	$more_runtime_exact_three['es-es'] = $more_runtime_exact_three['es-mx'];

	foreach ($more_runtime_exact_three as $more_exact_three_lang => $more_exact_three_items) {
		if (isset($translations[$more_exact_three_lang])) {
			$translations[$more_exact_three_lang] = array_merge($translations[$more_exact_three_lang], $more_exact_three_items);
		}
	}

	$games_folder_runtime_exact = array(
		'tr' => array(
			'Action' => 'Eylem',
			'Actions' => 'Eylemler',
			'Again' => 'Tekrar',
			'Amazing.' => 'Harika.',
			'Answer this round first.' => 'Önce bu turu cevapla.',
			'Available symbols' => 'Kullanılabilir semboller',
			'Base defense battlefield' => 'Üs savunma savaş alanı',
			'Blurred' => 'Bulanık',
			'Borrow' => 'Ödünç Al',
			'Box 1' => 'Kutu 1',
			'Box 2' => 'Kutu 2',
			...
			'Box 4' => 'Kutu 4',
			'Box 5' => 'Kutu 5',
			'Breakout 1000 game board' => 'Breakout 1000 oyun alanı',
			'Buy' => 'Satın Al',
			'Camera lock. You were too hot to hide.' => 'Kamera kilitlendi. Saklanmak için fazla sıcaktın.',
			'Check' => 'Kontrol Et',
			'Check Angle' => 'Açıyı Kontrol Et',
			'Cipher text' => 'Şifreli metin',
			'Clear 3 sections. Borrowing 5 seconds now adds more targets and decoys later.' => '3 bölümü temizle. Şimdi 5 saniye ödünç almak sonra daha fazla hedef ve tuzak ekler.',
			'Close' => 'Kapat',
			'Correct. The equation is balanced.' => 'Doğru. Denklem dengede.',
			'Current sequence' => 'Geçerli sıra',
			'Data core stolen. Now cross the exit without glowing too hot.' => 'Veri çekirdeği alındı. Şimdi fazla ısınmadan çıkışa geç.',
			'Decoy pressed. The future takes 2 seconds back.' => 'Tuzak basıldı. Gelecek 2 saniyeni geri aldı.',
			'Defeat' => 'Yenilgi',
			'Down' => 'Aşağı',
			'Enemy' => 'Düşman',
			'Enemies' => 'Düşmanlar',
			'Enter one letter.' => 'Bir harf gir.',
			'Example: The key must...' => 'Örnek: Anahtar şunu yapmalı...',
			'Final score:' => 'Son puan:',
			'Final score' => 'Son puan',
			'Fragile' => 'Kırılgan',
			'Game goals' => 'Oyun hedefleri',
			'Game stats' => 'Oyun istatistikleri',
			'Game speed' => 'Oyun hızı',
			'Go' => 'Git',
			'Great job. You won.' => 'Harika. Kazandın.',
			'Great job. You made 128.' => 'Harika. 128 yaptın.',
			'Great match.' => 'Harika eşleşme.',
			'Hard' => 'Zor',
			'Hero' => 'Kahraman',
			'Hero #' => 'Kahraman #',
			'HP' => 'Can',
			'Jump to hero number' => 'Kahraman numarasına git',
			'Keep merging tiles.' => 'Kutuları birleştirmeye devam et.',
			'Left' => 'Sol',
			'Lives' => 'Can',
			'Losses' => 'Yenilgi',
			'Miss. Try again.' => 'Iskaladın. Tekrar dene.',
			'Move' => 'Hareket',
			'Movement controls' => 'Hareket kontrolleri',
			'Need 4 blooms' => '4 çiçek gerekiyor',
			'Next Wave' => 'Sonraki Dalga',
			'Nice hit.' => 'Güzel vuruş.',
			'No more moves.' => 'Hamle kalmadı.',
			'Not balanced.' => 'Dengede değil.',
			'Not quite.' => 'Tam olmadı.',
			'Open Selected Game' => 'Seçili Oyunu Aç',
			'Out of moves.' => 'Hamle kalmadı.',
			'Page 1 / 84' => 'Sayfa 1 / 84',
			'Pick a game first.' => 'Önce bir oyun seç.',
			'Pick the number that makes the scale balance.' => 'Teraziyi dengeleyen sayıyı seç.',
			'Play Again' => 'Tekrar Oyna',
			'Power' => 'Güç',
			'Prev' => 'Önceki',
			'Rapid' => 'Seri',
			'Reach exit' => 'Çıkışa ulaş',
			'Ready' => 'Hazır',
			'Resistant' => 'Dirençli',
			'Restart Run' => 'Koşuyu Yeniden Başlat',
			'Right' => 'Sağ',
			'Rotate the blue pointer' => 'Mavi ibreyi döndür',
			'Round reset. Try again from the start.' => 'Tur sıfırlandı. Baştan tekrar dene.',
			'Run Over' => 'Koşu Bitti',
			'Select' => 'Seç',
			'Selected' => 'Seçili',
			'Showing heroes 1-12 of 1000' => 'Kahramanlar 1-12 / 1000',
			'Speed' => 'Hız',
			'Start Game' => 'Oyunu Başlat',
			'Start the match.' => 'Maçı başlat.',
			'Stats' => 'İstatistikler',
			'Steal core' => 'Çekirdeği al',
			'Sudoku board' => 'Sudoku tahtası',
			'Sudoku number pad' => 'Sudoku sayı paneli',
			'Target' => 'Hedef',
			'Tap the moving target.' => 'Hareket eden hedefe dokun.',
			'The grid is not full yet. Fill every square first.' => 'Tahta henüz dolu değil. Önce her kareyi doldur.',
			'The right answer is' => 'Doğru cevap',
			'Time is up. Press Restart to play again.' => 'Süre doldu. Tekrar oynamak için Yeniden Başlat’a bas.',
			'Try the puzzle again.' => 'Bulmacayı tekrar dene.',
			'Type your decoded phrase here' => 'Çözdüğün ifadeyi buraya yaz',
			'Up' => 'Yukarı',
			'Use arrow keys or swipe buttons to merge tiles.' => 'Kutuları birleştirmek için ok tuşlarını veya kaydırma düğmelerini kullan.',
			'Visible' => 'Görünür',
			'Victory' => 'Zafer',
			'Watch the rule. Then tap the correct arrow.' => 'Kuralı izle. Sonra doğru oka dokun.',
			'Wins' => 'Galibiyet',
			'You are below the target.' => 'Hedefin altındasın.',
			'You are above the target.' => 'Hedefin üstündesin.',
			'You ran out of lives.' => 'Canın bitti.',
			'You solved all puzzles!' => 'Tüm bulmacaları çözdün!',
		),
		'en' => array(
			'Başlat' => 'Start',
			...
			'Oyunu Yeniden Başlat' => 'Restart Game',
			'Tekrar Oyna' => 'Play Again',
			'Sonraki Dalga' => 'Next Wave',
			'Koşuyu Yeniden Başlat' => 'Restart Run',
			'Satın Al' => 'Buy',
			'Seç' => 'Select',
			'Seçili' => 'Selected',
			'Kahraman' => 'Hero',
	...
	foreach ($games_folder_runtime_exact as $games_exact_lang => $games_exact_items) {
		if (isset($translations[$games_exact_lang])) {
			$translations[$games_exact_lang] = array_merge($translations[$games_exact_lang], $games_exact_items);
		}
	}

	$games_folder_runtime_exact_extra = array(
		'tr' => array(
			'Your robot helper is waiting for its first lesson.' => 'Robot yardimcin ilk dersini bekliyor.',
			'Choose the best move for this round.' => 'Bu tur icin en iyi hamleyi sec.',
			'Training finished. Review the summary and restart for a new run.' => 'Egitim bitti. Ozeti incele ve yeni tur icin yeniden baslat.',
			...
			'Cannot take the square root of a negative number.' => 'Negatif sayinin karekoku alinamaz.',
			'Match the target color.' => 'Hedef rengi eslestir.',
			'You won Color Path.' => 'Color Path oyununu kazandin.',
			'Correct. Next round...' => 'Dogru. Sonraki tur...',
			'Wrong color. Try again.' => 'Yanlis renk. Tekrar dene.',
			'Build the combo!' => 'Komboyu olustur!',
			'Combo Complete! You Win!' => 'Kombo tamamlandi! Kazandin!',
			'Wrong combo! Try again.' => 'Yanlis kombo! Tekrar dene.',
			'All three services are restored. The city lights up again.' => 'Uc hizmet de duzeldi. Sehir tekrar isildiyor.',
			'Watch the sequence.' => 'Diziyi izle.',
			'Now repeat.' => 'Simdi tekrar et.',
			'Correct! Next level.' => 'Dogru! Sonraki seviye.',
			'Break every brick.' => 'Her tuglayi kir.',
			'Life lost. Launch again.' => 'Can gitti. Tekrar firlat.',
			'You beat all 1000 levels!' => '1000 seviyenin hepsini gectin!',
			'Write your decoded phrase first.' => 'Once cozdugun ifadeyi yaz.',
			'Not quite yet. Check your letters and try again.' => 'Henuz degil. Harflerini kontrol et ve tekrar dene.',
			'Here is the decoded phrase.' => 'Cozulmus ifade burada.',
			'Listen in your head. What family does it belong to?' => 'Icinden dinle. Hangi aileye ait?',
			'First round: Tap the SAME sound family' => 'Ilk tur: AYNI ses ailesine dokun',
			'First round: Tap a DIFFERENT sound family' => 'Ilk tur: FARKLI bir ses ailesine dokun',
			'Read the rule. Then tap the correct sound family.' => 'Kurali oku. Sonra dogru ses ailesine dokun.',
			'Sound Rule Rush' => 'Ses Kurali Yarisi',
			'Sort each sound into the right family.' => 'Her sesi dogru aileye ayir.',
			'Choose parts wisely.' => 'Parcalari dikkatli sec.',
			'Mission success. Robot performed well.' => 'Gorev basarili. Robot iyi calisti.',
			'Mission failed. Adjust your design.' => 'Gorev basarisiz. Tasarimini degistir.',
			'Choose a cell to expand or attack.' => 'Genislemek veya saldirmak icin bir hucre sec.',
			'Attack failed. The enemy held strong.' => 'Saldiri basarisiz. Dusman dayandi.',
			'AI captured territory this turn.' => 'Yapay zeka bu tur bolge ele gecirdi.',
			'AI attack failed. Your border remains intact.' => 'Yapay zeka saldirisi basarisiz. Sinirin saglam kaldi.',
			'Use Reinforce' => 'Takviye Kullan',
			'No player moves left. AI continues.' => 'Oyuncu hamlesi kalmadi. Yapay zeka devam ediyor.',
			'AI cannot move. Your turn.' => 'Yapay zeka hamle yapamiyor. Sira sende.',
			'AI wins! Try a different strategy.' => 'Yapay zeka kazandi! Farkli bir strateji dene.',
			'Reinforce used! You claimed a border space.' => 'Takviye kullanildi! Bir sinir alani aldin.',
			'The caravan reaches the city gates before the dunes close behind you.' => 'Kervan, kumullar kapanmadan sehir kapilarina ulasti.',
			'The caravan breaks apart in the dunes. Reset and try a safer route.' => 'Kervan kumullarda dagildi. Sifirla ve daha guvenli bir rota dene.',
			'Choose the next move before the desert shifts again.' => 'Col tekrar degismeden sonraki hamleyi sec.',
			'Watch the sequence carefully.' => 'Diziyi dikkatlice izle.',
			'Now repeat the sequence.' => 'Simdi diziyi tekrar et.',
			'Correct. Get ready for the next level.' => 'Dogru. Sonraki seviyeye hazirlan.',
			'Wrong order. Watch the sequence again.' => 'Yanlis sira. Diziyi tekrar izle.',
			'Pick a shape first.' => 'Once bir sekil sec.',
			'Pick another shape.' => 'Baska bir sekil sec.',
			'You sorted them all. Great job.' => 'Hepsini ayirdin. Harika.',
			'Correct. Pick the next shape.' => 'Dogru. Sonraki sekli sec.',
			'Wrong bin. Try again.' => 'Yanlis kutu. Tekrar dene.',
			'Find the treasure chest.' => 'Hazine sandigini bul.',
			'You won the treasure hunt.' => 'Hazine avini kazandin.',
			'You found the treasure. Next level...' => 'Hazineyi buldun. Sonraki seviye...',
			'That was a trap. Try another chest.' => 'Bu bir tuzakti. Baska sandik dene.',
			'You found all the treasure. You win.' => 'Tum hazineyi buldun. Kazandin.',
			'You hit a trap. Game over.' => 'Tuzaga bastin. Oyun bitti.',
			'Every 5 seconds the game sends 1 enemy. More Enemies sends 2.' => 'Her 5 saniyede oyun 1 dusman gonderir. Daha Fazla Dusman 2 gonderir.',
			'You cannot build on the path.' => 'Yolun ustune insa edemezsin.',
			'There is already a tower here.' => 'Burada zaten bir kule var.',
			'Not enough money for that tower.' => 'Bu kule icin yeterli para yok.',
			'More Enemies added 2 enemies.' => 'Daha Fazla Dusman 2 dusman ekledi.',
			'Work is cooling down. Wait a little.' => 'Calisma beklemede. Biraz bekle.',
			'Top path opened.' => 'Ust yol acildi.',
			'Top path blocked.' => 'Ust yol kapandi.',
			'Bottom path opened.' => 'Alt yol acildi.',
			'Bottom path blocked.' => 'Alt yol kapandi.',
			'At least one path must stay open.' => 'En az bir yol acik kalmali.',
			'Watch the loop sequence.' => 'Dongu dizisini izle.',
			'Repeat it now.' => 'Simdi tekrar et.',
			'Add all 5 moves.' => '5 hamlenin hepsini ekle.',
			'Great loop! You reached the goal.' => 'Harika dongu! Hedefe ulastin.',
			'No lives. Press Start.' => 'Can yok. Baslat dugmesine bas.',
			'You found the hidden stars.' => 'Gizli yildizlari buldun.',
			'Try again and catch more stars.' => 'Tekrar dene ve daha fazla yildiz yakala.',
			'Nice catch.' => 'Guzel yakalama.',
			'Too slow. Watch for the next one.' => 'Cok yavas. Sonrakini izle.',
			'Private game. Embed directly where you want it.' => 'Ozel oyun. Istedigin yere dogrudan gom.',
			'Buy upgrades and press Next Day to run the shop.' => 'Yukseltmeler al ve dukkani calistirmak icin Sonraki Gun dugmesine bas.',
			'Not enough money.' => 'Yeterli para yok.',
			'Upgrade bought.' => 'Yukseltme alindi.',
			'Advertising activated.' => 'Reklam etkinlestirildi.',
			'New day ready. Choose your next move.' => 'Yeni gun hazir. Sonraki hamleni sec.',
			'Game finished' => 'Oyun bitti',
			'Nothing to undo.' => 'Geri alinacak bir sey yok.',
			'Last move removed.' => 'Son hamle kaldirildi.',
			'Change one letter at a time to reach the target word.' => 'Hedef kelimeye ulasmak icin her seferinde bir harf degistir.',
		),
	);

	foreach ($games_folder_runtime_exact_extra as $games_exact_extra_lang => $games_exact_extra_items) {
		if (isset($translations[$games_exact_extra_lang])) {
			$translations[$games_exact_extra_lang] = array_merge($translations[$games_exact_extra_lang], $games_exact_extra_items);
		}
	}
...
function zo_get_runtime_translation_replacements($lang) {
	...
	$more_game_replacements_two = array(
		'tr' => array(
			array('Question ', 'Soru '),
			array('Page ', 'Sayfa '),
			array('Showing heroes ', 'Kahramanlar gösteriliyor '),
			array('Distance to city: ', 'Şehre mesafe: '),
			array('HP: ', 'Can: '),
			array('Your Rocket • Lv', 'Senin Roketin • Sv'),
			array('Enemy Rocket • Lv', 'Düşman Roketi • Sv'),
			array('Sorted ', 'Sıralandı '),
			array(' shapes', ' şekil'),
			array('Leader says: ', 'Lider diyor ki: '),
			array('Wrong. Opposite was "', 'Yanlış. Tersi "'),
			array('".', '".'),
			array('Speed ', 'Hız '),
			array('Smart ', 'Zeka '),
			array('Shooting ', 'Şut '),
			array('Passing ', 'Pas '),
			array('Defense ', 'Savunma '),
			array('Clear 3 sections. Borrowing 5 seconds now adds more targets and decoys later.', '3 bölümü temizle. Şimdi 5 saniye ödünç almak sonra daha fazla hedef ve şaşırtma ekler.'),
			array('Time collectors caught up to you. Restart and borrow less.', 'Zaman toplayıcıları sana yetişti. Yeniden başla ve daha az ödünç al.'),
			array('Stage ', 'Aşama '),
			array(' started. Clear all blue tiles before time runs out.', ' başladı. Süre dolmadan tüm mavi karoları temizle.'),
			array('You borrowed 5 seconds. Future sections just got meaner.', '5 saniye ödünç aldın. Gelecek bölümler zorlaştı.'),
			array('You escaped the timeline with debt of ', 'Zaman çizgisinden borçla kaçtın: '),
			array(' seconds.', ' saniye.'),
			array('Section cleared. Your debt follows you into the next room.', 'Bölüm temizlendi. Borcun sonraki odaya geliyor.'),
			array('Repeat: ', 'Tekrarla: '),
			array('Chest ', 'Sandık '),
			array('Day: ', 'Gün: '),
			array('Money: ', 'Para: '),
			array('Customers: ', 'Müşteriler: '),
			array('Happiness: ', 'Mutluluk: '),
			array('Workers: ', 'Çalışanlar: '),
			array('Product Level: ', 'Ürün Seviyesi: '),
			array('Upgrades: ', 'Yükseltmeler: '),
			array('No country selected yet', 'Henüz ülke seçilmedi'),
			array('Country: ', 'Ülke: '),
			array('Hint: ', 'İpucu: '),
			array('Catch ', 'Yakalanacak: '),
			array(' stars before time runs out.', ' yıldız, süre dolmadan.'),
			array('Score: ', 'Skor: '),
			array('Su: ', 'Su: '),
			array('En iyi su: ', 'En iyi su: '),
		),
		'en' => array(
			array('Soru ', 'Question '),
			array('Ülke: ', 'Country: '),
			array('İpucu: ', 'Hint: '),
			array('Dükkan Seviyesi ', 'Shop Level '),
			array('Süre: ', 'Time: '),
			array('Su: ', 'Water: '),
			array('En iyi su: ', 'Best water: '),
		),
		'de' => array(
			array('Question ', 'Frage '),
			array('Page ', 'Seite '),
			array('Showing heroes ', 'Helden angezeigt '),
			array('Distance to city: ', 'Entfernung zur Stadt: '),
			array('HP: ', 'LP: '),
			array('Your Rocket • Lv', 'Deine Rakete • Lv'),
			array('Enemy Rocket • Lv', 'Feindrakete • Lv'),
			array('Sorted ', 'Sortiert '),
			array(' shapes', ' Formen'),
			array('Leader says: ', 'Leiter sagt: '),
			array('Wrong. Opposite was "', 'Falsch. Das Gegenteil war "'),
			array('Speed ', 'Tempo '),
			array('Smart ', 'Klugheit '),
			array('Shooting ', 'Schuss '),
			array('Passing ', 'Passspiel '),
			array('Defense ', 'Abwehr '),
			array('Repeat: ', 'Wiederhole: '),
			array('Chest ', 'Truhe '),
			array('Day: ', 'Tag: '),
			array('Money: ', 'Geld: '),
			array('Customers: ', 'Kunden: '),
			array('Happiness: ', 'Zufriedenheit: '),
			array('Workers: ', 'Arbeiter: '),
			array('Product Level: ', 'Produktlevel: '),
			array('Upgrades: ', 'Upgrades: '),
			array('Country: ', 'Land: '),
			array('Hint: ', 'Hinweis: '),
			...
			array('Score: ', 'Punkte: '),
			array('Su: ', 'Wasser: '),
			array('En iyi su: ', 'Bestes Wasser: '),
		),
		'fr' => array(
			array('Question ', 'Question '),
			array('Page ', 'Page '),
			array('Showing heroes ', 'Héros affichés '),
			array('Distance to city: ', 'Distance jusqu à la ville : '),
			array('HP: ', 'PV : '),
			array('Your Rocket • Lv', 'Ta fusée • Niv'),
			array('Enemy Rocket • Lv', 'Fusée ennemie • Niv'),
			array('Sorted ', 'Trié '),
			array(' shapes', ' formes'),
			array('Leader says: ', 'Le chef dit : '),
			array('Wrong. Opposite was "', 'Faux. L opposé était "'),
			array('Speed ', 'Vitesse '),
			array('Smart ', 'Intelligence '),
			array('Shooting ', 'Tir '),
			array('Passing ', 'Passe '),
			array('Defense ', 'Défense '),
			array('Repeat: ', 'Répète : '),
			array('Chest ', 'Coffre '),
			array('Day: ', 'Jour : '),
			array('Money: ', 'Argent : '),
			array('Customers: ', 'Clients : '),
			array('Happiness: ', 'Bonheur : '),
			array('Workers: ', 'Travailleurs : '),
			array('Product Level: ', 'Niveau produit : '),
			array('Upgrades: ', 'Améliorations : '),
			array('Country: ', 'Pays : '),
			array('Hint: ', 'Indice : '),
			array('Catch ', 'Attrape '),
		...
		'es-mx' => array(
			array('Question ', 'Pregunta '),
			array('Page ', 'Página '),
			array('Showing heroes ', 'Mostrando héroes '),
			array('Distance to city: ', 'Distancia a la ciudad: '),
			array('HP: ', 'PS: '),
			array('Your Rocket • Lv', 'Tu cohete • Nv'),
			array('Enemy Rocket • Lv', 'Cohete enemigo • Nv'),
			array('Sorted ', 'Ordenadas '),
			array(' shapes', ' formas'),
			array('Leader says: ', 'El líder dice: '),
			array('Wrong. Opposite was "', 'Incorrecto. Lo opuesto era "'),
			array('Speed ', 'Velocidad '),
			array('Smart ', 'Inteligencia '),
			array('Shooting ', 'Tiro '),
			array('Passing ', 'Pase '),
			array('Defense ', 'Defensa '),
			array('Repeat: ', 'Repite: '),
			array('Chest ', 'Cofre '),
			array('Day: ', 'Día: '),
			array('Money: ', 'Dinero: '),
			...
			array('Happiness: ', 'Felicidad: '),
			array('Workers: ', 'Trabajadores: '),
			array('Product Level: ', 'Nivel de producto: '),
			array('Upgrades: ', 'Mejoras: '),
			array('Country: ', 'País: '),
			array('Hint: ', 'Pista: '),
			array('Catch ', 'Atrapa '),
	...
	$more_game_replacements_two['es-es'] = array_merge($more_game_replacements_two['es-mx'], array(
		array('Product Level: ', 'Nivel de producto: '),
	));

	foreach ($more_game_replacements_two as $more_rep_two_lang => $more_rep_two_items) {
		if (isset($common_replacements[$more_rep_two_lang])) {
			$common_replacements[$more_rep_two_lang] = array_merge($more_rep_two_items, $common_replacements[$more_rep_two_lang]);
		}
	}

	$roster_replacements = array(
		'tr' => array(
			array('Spark #', 'Kıvılcım #'),
			array('Shield #', 'Kalkan #'),
			array('Nova #', 'Nova #'),
			array('Echo #', 'Yankı #'),
			array('Bloom #', 'Çiçek #'),
			...
			array('Showing heroes ', 'Kahramanlar gösteriliyor '),
			array('Page ', 'Sayfa '),
			array('Pick or buy a character', 'Bir karakter seç veya satın al'),
			array('Level ', 'Seviye '),
			array(' started. Enemies get tougher and more numerous every wave.', ' başladı. Düşmanlar her dalgada daha güçlü ve daha kalabalık olur.'),
			array('Wave cleared. You earned 50 coins. Press Next Wave when you are ready for level ', 'Dalga temizlendi. 50 coin kazandın. Seviye için hazır olduğunda Sonraki Dalga’ya bas: '),
			array('Press Next Wave to continue to level ', 'Seviyeye devam etmek için Sonraki Dalga’ya bas: '),
		),
		'de' => array(
			array('Spark #', 'Funke #'),
			array('Shield #', 'Schild #'),
			...
			array('Cost: ', 'Kosten: '),
			array(' coins.', ' Münzen.'),
			array(' started. Enemies get tougher and more numerous every wave.', ' gestartet. Gegner werden jede Welle stärker und zahlreicher.'),
			array('Wave cleared. You earned 50 coins. Press Next Wave when you are ready for level ', 'Welle geschafft. Du hast 50 Münzen verdient. Drücke Nächste Welle, wenn du bereit bist für Level '),
			array('Press Next Wave to continue to level ', 'Drücke Nächste Welle, um fortzufahren zu Level '),
		),
		'fr' => array(
			array('Spark #', 'Étincelle #'),
			array('Shield #', 'Bouclier #'),
			array('Nova #', 'Nova #'),
			array('Echo #', 'Écho #'),
			array('Bloom #', 'Fleur #'),
			array('Stone #', 'Pierre #'),
			...
			array('Cost: ', 'Coût : '),
			array(' coins.', ' pièces.'),
			array(' started. Enemies get tougher and more numerous every wave.', ' commencé. Les ennemis deviennent plus forts et plus nombreux à chaque vague.'),
			array('Wave cleared. You earned 50 coins. Press Next Wave when you are ready for level ', 'Vague terminée. Tu as gagné 50 pièces. Appuie sur Vague suivante quand tu es prêt pour le niveau '),
			array('Press Next Wave to continue to level ', 'Appuie sur Vague suivante pour continuer au niveau '),
		),
		'es-mx' => array(
			array('Spark #', 'Chispa #'),
			array('Shield #', 'Escudo #'),
			...
			array('Cost: ', 'Costo: '),
			array(' coins.', ' monedas.'),
			array(' started. Enemies get tougher and more numerous every wave.', ' iniciado. Los enemigos son más fuertes y numerosos en cada ola.'),
			array('Wave cleared. You earned 50 coins. Press Next Wave when you are ready for level ', 'Ola completada. Ganaste 50 monedas. Presiona Siguiente ola cuando estés listo para el nivel '),
			array('Press Next Wave to continue to level ', 'Presiona Siguiente ola para continuar al nivel '),
		),
	);
	$roster_replacements['es-es'] = $roster_replacements['es-mx'];

	foreach ($roster_replacements as $roster_rep_lang => $roster_rep_items) {
		if (isset($common_replacements[$roster_rep_lang])) {
			$common_replacements[$roster_rep_lang] = array_merge($roster_rep_items, $common_replacements[$roster_rep_lang]);
		}
	}
	...
	$games_folder_replacements = array(
		'tr' => array(
			array('Final score:', 'Son puan:'),
			array('Total Score:', 'Toplam puan:'),
			array('Game over.', 'Oyun bitti.'),
			array('Game over', 'Oyun bitti'),
			array('No more moves.', 'Hamle kalmadı.'),
			array('Press Check', 'Kontrol Et düğmesine bas'),
			array('Press Play Again', 'Tekrar Oyna düğmesine bas'),
			array('Press Restart', 'Yeniden Başlat düğmesine bas'),
			array('Press Start Game', 'Oyunu Başlat düğmesine bas'),
			array('Start Game', 'Oyunu Başlat'),
			array('Next Wave', 'Sonraki Dalga'),
			array('Restart Run', 'Koşuyu Yeniden Başlat'),
			array('Check Angle', 'Açıyı Kontrol Et'),
			array('Open Selected Game', 'Seçili Oyunu Aç'),
			array('Use arrow keys', 'Ok tuşlarını kullan'),
			array('Use Arrow keys', 'Ok tuşlarını kullan'),
			array('Arrow keys', 'ok tuşları'),
			array('swipe buttons', 'kaydırma düğmeleri'),
			array('move buttons', 'hareket düğmeleri'),
			array('on desktop', 'bilgisayarda'),
			array('On mobile', 'Mobilde'),
			array('tap the arena', 'arenaya dokun'),
			array('Clear each wave', 'Her dalgayı temizle'),
			array('earn 50 coins', '50 coin kazan'),
			array('buy stronger characters', 'daha güçlü karakterler satın al'),
			array('The right answer is', 'Doğru cevap'),
			array('You ran out of lives.', 'Canın bitti.'),
			array('You are below the target.', 'Hedefin altındasın.'),
			array('You are above the target.', 'Hedefin üstündesin.'),
			array('You landed on', 'Şuna indin:'),
			array('but needed', 'ama gereken'),
			array('Not quite.', 'Tam olmadı.'),
			array('Great match.', 'Harika eşleşme.'),
			array('Round reset.', 'Tur sıfırlandı.'),
			array('Try again from the start.', 'Baştan tekrar dene.'),
			array('Time is up.', 'Süre doldu.'),
			array('No coins this round.', 'Bu tur coin yok.'),
			array('Next duck coming up', 'Sonraki ördek geliyor'),
			array('Duck revealed under box', 'Ördek şu kutunun altındaydı:'),
			array('The duck was under box', 'Ördek şu kutunun altındaydı:'),
			array('You found the duck', 'Ördeği buldun'),
			array('all 30 ducks', '30 ördeğin hepsini'),
			array('one duck is hiding', 'bir ördek saklanıyor'),
			array('Find 30 ducks', '30 ördek bul'),
			array('Showing heroes', 'Kahramanlar'),
			array('of 1000', '/ 1000'),
			array('Tier', 'Kademe'),
			array('Cost:', 'Bedel:'),
			array('Run Over', 'Koşu Bitti'),
			array('Roster 1000 Arena', '1000 Karakter Arenası'),
			array('Hero Shop', 'Kahraman Mağazası'),
			array('Hero #', 'Kahraman #'),
			array('Jumped to hero #', 'Kahraman #'),
			array('is now selected.', 'artık seçili.'),
			array('Bought', 'Satın alındı:'),
			array('Not enough coins for', 'Yeterli coin yok:'),
			array('Win more waves', 'Daha fazla dalga kazan'),
			array('Stage ', 'Aşama '),
			array(' started.', ' başladı.'),
			array(' left', ' kaldı'),
			array(' ready', ' hazır'),
			array(' done', ' bitti'),
			array('Visible', 'Görünür'),
			array('Blurred', 'Bulanık'),
			array('Fragile', 'Kırılgan'),
			array('Resistant', 'Dirençli'),
			array('Steal core', 'Çekirdeği al'),
			array('Reach exit', 'Çıkışa ulaş'),
			array('Need 4 blooms', '4 çiçek gerekiyor'),
			array('Thermal scan updates.', 'Termal tarama güncellendi.'),
			array('Keep your signature low near the cameras.', 'Kameraların yanında izini düşük tut.'),
			array('Data core stolen.', 'Veri çekirdeği alındı.'),
			array('Heist complete.', 'Soygun tamamlandı.'),
			array('Camera lock.', 'Kamera kilitlendi.'),
			array('Expand across the body.', 'Vücuda yayıl.'),
			array('Mutation purchased.', 'Mutasyon satın alındı.'),
			array('Immune attack blocked by mutation.', 'Bağışıklık saldırısı mutasyonla engellendi.'),
			array('Colony expanded.', 'Koloni genişledi.'),
			array('Cell colony selected.', 'Hücre kolonisi seçildi.'),
			array('Body sector dominated.', 'Vücut bölgesi ele geçirildi.'),
			array('Plants only grow in shadow.', 'Bitkiler yalnızca gölgede büyür.'),
			array('The sun moved.', 'Güneş hareket etti.'),
			array('The garden is thriving.', 'Bahçe gelişiyor.'),
			array('Seeds stay in place.', 'Tohumlar yerinde kalır.'),
			array('You removed a stone', 'Bir taşı kaldırdın'),
			array('A new object', 'Yeni bir nesne'),
			array('You can only keep', 'En fazla tutabileceğin'),
			array('Shadow mastered.', 'Gölge ustalaştı.'),
			array('Too much light', 'Çok fazla ışık'),
			array('Room cleared.', 'Oda temizlendi.'),
			array('All rooms cleared.', 'Tüm odalar temizlendi.'),
			array('Caught by a ceiling crawler.', 'Tavan gezgini yakaladı.'),
			array('Out of moves.', 'Hamle kalmadı.'),
			array('Reach the door on the right.', 'Sağdaki kapıya ulaş.'),
		),
	);

	if (isset($phrases[$lang], $games_folder_replacements[$lang])) {
		$phrases[$lang] = array_merge($games_folder_replacements[$lang], $phrases[$lang]);
	}
...
function zo_wrap_game_runtime_translator($html, $module, $lang) {
	...
	$script = '<script>(function(){'
		...
		. 'if(!root){return;}'
		. 'const scanRoot=root.closest(".zo-game-page")||root.closest(".zo-shortcode-frame")||root;'
		...
		. 'root.__zoTranslate=tx;if(scanRoot&&scanRoot!==root){scanRoot.__zoTranslate=tx;}window.__zoGameI18nTranslateCanvas=function(canvas,value){if(typeof value!=="string"||!canvas||canvas.hasAttribute("data-zo-no-canvas-translate")){return value;}const shell=canvas.closest&&canvas.closest(".zo-game-shell,.zo-game-page,.zo-shortcode-frame");const fn=shell&&shell.__zoTranslate;return fn?fn(value):value;};'
		...
		. 'if(!window.__zoI18nDialogPatched){["alert","confirm","prompt"].forEach(function(method){const original=window[method];if(typeof original!=="function"){return;}window[method]=function(message){if(typeof message==="string"&&scanRoot&&scanRoot.__zoTranslate){arguments[0]=scanRoot.__zoTranslate(message);}if(method==="prompt"&&typeof arguments[1]==="string"&&scanRoot&&scanRoot.__zoTranslate){arguments[1]=scanRoot.__zoTranslate(arguments[1]);}return original.apply(window,arguments);};});window.__zoI18nDialogPatched=true;}'
		...
		. 'function attrs(el){attrNames.forEach(function(name){if(!el.hasAttribute||!el.hasAttribute(name)){return;}const next=tx(el.getAttribute(name));if(next!==el.getAttribute(name)){el.setAttribute(name,next);}});if(locale&&el.hasAttribute&&el.hasAttribute("data-locale")){el.setAttribute("data-locale",locale);}if(el.matches&&el.matches("input[type=button],input[type=submit],input[type=reset],button")&&el.hasAttribute("value")){const next=tx(el.getAttribute("value"));if(next!==el.getAttribute("value")){el.setAttribute("value",next);try{el.value=next;}catch(error){}}}if(el.matches&&el.matches("option")&&el.hasAttribute("label")){const next=tx(el.getAttribute("label"));if(next!==el.getAttribute("label")){el.setAttribute("label",next);}}if(el.matches&&el.matches("input:not([type]),input[type=text],input[type=search]")&&el.hasAttribute("placeholder")){const next=tx(el.getAttribute("placeholder"));if(next!==el.getAttribute("placeholder")){el.setAttribute("placeholder",next);}}}'
		...
		. 'function pageTitle(){if(typeof document.title==="string"){const next=tx(document.title);if(next!==document.title){document.title=next;}}}'
		. 'walk(scanRoot);pageTitle();'
		. 'setTimeout(function(){walk(scanRoot);pageTitle();},0);setTimeout(function(){walk(scanRoot);pageTitle();},250);setTimeout(function(){walk(scanRoot);pageTitle();},900);window.addEventListener&&window.addEventListener("load",function(){walk(scanRoot);pageTitle();});'
		...
		. 'observer.observe(scanRoot,{childList:true,subtree:true,characterData:true,attributes:true,attributeFilter:attrNames.concat(["value","data-locale"])});'
		. '})();</script>';
...
.zo-games-grid__tabs.is-dragging {
	cursor: grabbing;
	user-select: none;
}
.zo-games-grid__tabs::before {
	content: "";
	position: absolute;
	top: 4px;
	bottom: 4px;
...
.zo-games-grid__tabs.is-dragging::before {
	transition: none;
}
.zo-games-grid__owner-counts {
	order: 3;
	display: inline-flex;
	flex: 0 0 auto;
	align-items: center;
...
.zo-games-grid__owner-counts-separator {
	width: 1px;
	height: 16px;
	background: #dbe3ee;
}
.zo-games-grid__owner-counts-owner {
	color: #1d4ed8;
}
.zo-games-grid__owner-counts-owner--arslan {
	color: #ea580c;
}
.zo-games-grid__tabs--all {
	--zo-tab-offset: 0;
}
.zo-games-grid__tabs--asker {
	--zo-tab-offset: 100%;
}
...
function zo_account_shortcode($atts = array()) {
	...
	return '<div class="zo-account"><h2>Make your account</h2><p class="zo-account__hint">Choose a username and a PIN of 4–9 digits.</p>' . $message_html
		...
		. '<div class="zo-account__actions"><button type="submit" name="zo_account_action" value="register" class="zo-account__create">Create account</button><button type="submit" name="zo_account_action" value="login" class="zo-account__secondary">Sign in</button></div></form></div>';
}
...
function zo_games_grid_shortcode($atts = array()) {
	...
	echo '<div class="zo-games-grid__topbar">';
