...
$zo_echo_cartographer_dir = __DIR__;
$zo_echo_cartographer_css = $zo_echo_cartographer_dir . '/style.css';

$zo_echo_cartographer_inline_style  = file_exists($zo_echo_cartographer_css) ? (string) file_get_contents($zo_echo_cartographer_css) : '';
$zo_echo_cartographer_inline_script = <<<'JS'
(function () {
	const MAPS = [
		[
			'#########',
...
return array(
	...
	'inline_style'    => $zo_echo_cartographer_inline_style,
	'inline_script'   => $zo_echo_cartographer_inline_script,
);
